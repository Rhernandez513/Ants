...
bool Movement(GameField field, Overlap)
{
	...
	temp.ant1 = nullptr;
	temp.ant2 = nullptr;
	// while the ant queen of either side is not dead(so a while loop will be needed)
	...
	//returns: -1: both queens killed, draw. 0: both ants killed, game not over yet. 1:first ant killed second. 2: second killed first. 3: queen 2 killed, team 1 won. 4: queen 1 killed, team 2 won
